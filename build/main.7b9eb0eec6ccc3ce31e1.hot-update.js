...
eval("throw new Error(\"Module parse failed: Cannot use keyword 'await' outside an async function (27:16)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|             await newPayment.save();\\n|             cart.filter(item => {\\n>                 await Database_1.DB.Models.Product.findOneAndUpdate({ _id: id }, { sold: item.qty + item.sold });\\n|             });\\n|             return res.status(400).json({ message: \\\"success\\\", data: items });\");\n\n//# sourceURL=webpack:///./src/controllers/PaymentController.ts?");
